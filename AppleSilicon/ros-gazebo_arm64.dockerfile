...
# ------------------------------------ #
# To Build
# docker build -t imagename:tag -f AppleSilicon/ros-gazebo_arm64.dockerfile .
# To Run
# docker run -e DISPLAY=host.docker.internal:0 --rm -it --privileged woensugchoi/ros-gazebo:apple_arm64
